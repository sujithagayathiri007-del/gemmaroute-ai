...
function App() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.log(error);
      setDisplayedText("Error connecting to backend");
    }
  ...
  return (
    <div className="container">
      ...
      <button onClick={handleSubmit}>
        {loading ? "Generating AI Route..." : "Simplify Address"}
      </button>
      ...
      {displayedText && (
        <div className="result-box">
          ...
          <div className="gps-box">
            ...
            <p>🛵 Driver Distance: 300m away</p>

            <p>⏱ Estimated Arrival: 2 mins</p>

            <p>🧭 Next Turn: Left near temple</p>

            <p>🚚 Delivery Type: {priority}</p>
      ...
      <footer>
        Powered by Gemma + FastAPI + React + Gemini AI
      </footer>
